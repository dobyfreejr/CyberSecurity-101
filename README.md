...
+ #### Maze was the dominant ransomware family

### 2. Describe three different pandemic-related eCrime Phishing themes.


+ #### Scams offering Personal Protective Equipment (PPE). Tailored attacks against employees working from home. Financial assistance and government stimulus packages.
...
+ #### They are an adversary from china
### 5. Which ransomware actor was the first observed using data extortion in a ransomware campaign?
+ #### Outlaw spider was the first observed using data extortion in ransomware campaigns 
### 6. What is an access broker?
+ #### Access brokers are threat actors that gain backend access to various organizations(Corporations & Government) and sell this access to either criminals or through private channels 
### 7. Explain a credential-based attack.
+ #### Attackers steal credentials to gain access ,bypass an organization security measures and steal critical data or do other harmful things to the system. 
...
+ #### SPRITE SPIDER & CARBON SPIDER  were able to gain administrator access through web base credentials being stored. They were then able to encrypt the data. Which inflicts the same amount of damage as a ransomware attack.
### 13. What role does an Enabler play in an eCrime ecosystem?
+ #### They Provide services to those whom wish to carry out cyber attacks
...
+ #### The malicious code that was used was SUNBURST .
...
+ #### Credential stuff is when you use wordlist or other forms of username passwords to obtain access to domain . Usually involves people information previous being leaked.
...
+ #### 55% of players experience their accounts being compromised and 20% expressed being worried, 
### 6. What is a three-question quiz phishing attack?
+ #### Ask the user three questions pertaining to the imitated target to gain access to the users sensitive information
### 7. Explain how Prolexic Routed defends organizations against DDoS attacks.
+ #### Prolexic routed stops attacks with a cloud based DDoS scrubbing platform to protect your applications when ever they are deployed.
...
+ #### May 14 2020 had seen 47,698,955 Daily Credentials Abuse Attempts
...
+ #### July 11 2020 had seen 14,631,618 Daily Web applications Attacks- Gaming 
...
+ #### August 20,2020 had seen 5,150,760 Daily Web Application Attacks- Media 
...
+ #### Incident is something that comprises the Integrity ,Confidentiality and Availability of an asset, Breach is when the asset information has been exposed to unauthorized parties
### 2. What percentage of breaches were perpetrated by outside actors? What percentage were perpetrated by internal actors? 
+ #### 80% of breaches were perpetrated by outside actors and 35% of breaches were perpetrated by internal actors
### 3. What percentage of breaches were perpetrated by organized crime? 
+ #### 79% of organized crime 
### 4. What percentage of breaches were financially motivated? 
+ #### 70% of breaches were financially motivated 
### 5. Define the following (additional research may be required outside of the report): 
+ #### **Denial of service**:is an attack meant to shutdown a machine or network making it inaccessible to its intended users 


+ #### **Command control**: Happens when back actors infiltrate a systems and install malware that lets them remotely send commands from a C2 server to infected devices 


+ #### **Backdoor**:is when a authorized or unauthorized user gain access by going around normal security measures to gain root access to a computer systems


+ #### **Keylogger**: Log every key stroke made . it allows the unintended user ability to record passwords and usernames for Financial gain or other uses
